...
const translations = {
  ...
  zh: {
    ...
    youreAllSet: '全部设置完毕!',
    agentReady: '您的 AgentBear 加密代理已准备好发现机会',
    whatsNext: '下一步:',
    agentRunning: '代理在端口 8080 上运行',
    chatBot: '在 Telegram 上与您的机器人聊天 (@YourAgentBearBot)',
  ...
  ko: {
    ...
    agentReady: '당신의 AgentBear 암호 에이전트가 기회를 찾을 준비가 되었습니다',
    whatsNext: '다음 단계:',
    agentRunning: '에이전트가 포트 8080에서 실행 중입니다',
    chatBot: 'Telegram에서 봇과 채팅 (@YourAgentBearBot)',
  ...
  ja: {
    ...
    agentReady: 'AgentBear 暗号エージェントは機会を見つける準備ができています',
    whatsNext: '次のステップ:',
    agentRunning: 'エージェントがポート 8080 で実行中',
    chatBot: 'Telegram でボットとチャット (@YourAgentBearBot)',
  ...
  es: {
    title: 'Asistente de Configuración de AgentBear',
    ...
    welcome: 'Bienvenido a AgentBear',
    ...
    agentReady: 'Tu Agente Crypto AgentBear está listo para encontrar oportunidades',
    whatsNext: 'Próximos pasos:',
    agentRunning: 'El agente se ejecuta en el puerto 8080',
    chatBot: 'Chatea con tu bot en Telegram (@YourAgentBearBot)',
